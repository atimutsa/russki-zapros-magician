  ...
  const cases = [
    {
      ...
      fullDescription: "Клиент FitNetwork - сеть фитнес-клубов с высокой конкуренцией и проблемой удержания клиентов. Основная задача заключалась в возврате клиентов, которые длительное время не посещали залы. Традиционные методы обзвона показывали низкую эффективность и требовали больших трудозатрат от менеджеров.",
      solution: "TWIN внедрил систему голосового бота, который автоматически обзванивает неактивных клиентов через 7, 14 и 30 дней после последнего посещения. Бот предлагает специальные условия возврата и записывает на пробные занятия с тренером.",
      clientFeedback: "Благодаря TWIN мы смогли автоматизировать работу с неактивными клиентами и значительно улучшить показатели возвратности. Система работает круглосуточно и не требует постоянного контроля."
    },
    {
      id: 2,

...
import casePlasticWindows from "@/assets/case-plastic-windows.jpg";
import caseBlindsAutomation from "@/assets/case-blinds-automation.jpg";
import caseWhatsappReactivation from "@/assets/case-whatsapp-reactivation.jpg";
...
const CaseStudies = () => {
  ...
  const cases = [
    ...
    {
      id: 3,
      title: "Как компания по продаже жалюзи с помощью рассылки TWIN в WhatsApp реанимировала клиентов и выявила новые возможности для продаж",
      client: "Компания по продаже жалюзи",
      description: "Вернули лояльность клиентской базы, повысили активность на 30%, выявили слабые места в продукции и создали базу клиентов с отложенным спросом.",
      results: [
        "Рост повторных покупок на 30%",
        "Выявление проблемных зон в продукции",
        "Создание базы с отложенным спросом",
        "Минимизация блокировок в WhatsApp",
      ],
      image: caseWhatsappReactivation,
      color: "from-purple-500 to-pink-500",
      fullDescription: "Компания, производитель и продавец жалюзи, рольставен и москитных сеток, работает в сегментах B2B и B2C, обслуживая как корпоративных, так и частных клиентов. Основная задача заключалась в реанимации старой базы покупателей, которые не совершали повторных заказов более года. Компания стремилась вернуть интерес и лояльность старых клиентов. Ранее WhatsApp-рассылки часто блокировались из-за восприятия их как спам. Кроме того, за время использования у некоторых клиентов накопились негативные впечатления, и компания искала способ выявить и устранить эти проблемные моменты.",
      solution: "TWIN предложил стратегию поэтапного взаимодействия с клиентами через WhatsApp-рассылку, начинающуюся с сервисного вопроса и плавно переходящую к предложениям акций. Бот обращался к клиенту с вопросом о впечатлениях от купленных ранее жалюзи: «Здравствуйте, меня зовут Карина. Вы покупали у нас жалюзи в марте 2022 года. Хотим узнать, как вам изделия, всё ли устраивает?» В зависимости от ответа клиенты делились на группы: проблемы с изделиями (предложение гарантийного решения и скидки 40%), положительный отклик (скидка 40% на новые изделия), не помнят покупку (информация о компании и предложениях). Сценарий был протестирован на небольшом сегменте для минимизации блокировок.",
      clientFeedback: "Решение от TWIN не только помогло вернуть старых клиентов, но и выявить слабые места в продукции. Мы получили новую базу клиентов с отложенным спросом и планируем использовать стратегию сбора отзывов для дальнейшего роста лояльности и имиджа компании."
    },
  ];
